...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng barcelona = new LatLng(37.408884,-122.036987);
        mMap.addMarker(new MarkerOptions().position(barcelona).title("Marker in Barcelona"));

        LatLng madrid = new LatLng(37.407203,-122.038090);
        mMap.addMarker(new MarkerOptions().position(madrid).title("Marker in Madrid"));

        LatLng zaragoza = new LatLng(37.408884,-122.036987);

        //Define list to get all latlng for the route
        List<LatLng> path = getRoute(barcelona, madrid);
    ...
    List<LatLng> getRoute(LatLng src, LatLng dst) {
        ...
        GeoApiContext context = new GeoApiContext.Builder()
                ...
                .build();
        DirectionsApiRequest req = DirectionsApi.getDirections(context, src.toString(), dst.toString());
        try {
