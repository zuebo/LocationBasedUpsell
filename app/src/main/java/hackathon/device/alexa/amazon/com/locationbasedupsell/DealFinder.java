...
public class DealFinder {
    ...
    private void populateDealDatabase() {
        ...
        try {
            ...
            //restaurants
            record = new JSONObject("{\"southwest\":{\"latitude\":37.390322,\"longitude\":-122.031695},\"northeast\":{\"latitude\":37.3960397,\"longitude\":-122.0332951},\"dealType\":\"restaurant\",\"deals\":[{\"location\":{\"latitude\":37.394321,\"longitude\":-122.0310037},\"company\":\"Dish n' Dash\",\"description\":\"736 N Mathilda Ave, Sunnyvale, CA 94085\\n Free salad/fries with lunch!\",\"provider\":\"Yelp\"},{\"location\":{\"latitude\":37.394321,\"longitude\":-122.0310037},\"company\":\"Hobee's\",\"description\":\"800 W Ahwanee Ave, Sunnyvale, CA 94085\\n Free drink with lunch/dinner!\",\"provider\":\"Yelp\"}]}");
            dealDatabase.add(record);
            record = new JSONObject("{\"southwest\":{\"latitude\":37.3865918,\"longitude\":-122.0350413},\"northeast\":{\"latitude\":37.3889616,\"longitude\":-122.0301597},\"dealType\":\"restaurants\",\"deals\":[{\"location\":{\"latitude\":37.3865267,\"longitude\":-122.0331342},\"company\":\"Le Boulanger\",\"description\":\"305 N Mathilda Ave, Sunnyvale, CA 94085\\n 15% off lunch! Valid today only\",\"provider\":\"Yelp\"},{\"location\":{\"latitude\":37.3865267,\"longitude\":-122.0331342},\"company\":\"Kal's Bar-B-Q\",\"description\":\"425 N Mathilda Ave, Sunnyvale, CA 94085\\n Free drink with lunch/dinner!\",\"provider\":\"Yelp\"}]}");
            dealDatabase.add(record);
            record = new JSONObject("{\"southwest\":{\"latitude\":37.3772527,\"longitude\":-122.0338413},\"northeast\":{\"latitude\":37.379361,\"longitude\":-122.026205},\"dealType\":\"restaurant\",\"deals\":[{\"location\":{\"latitude\":37.37,\"longitude\":-122.03},\"company\":\"Inchin's Bamboo Garden\",\"description\":\"151 W Washington Ave, Sunnyvale, CA 94087\\n Free drink with dinner!\",\"provider\":\"Yelp\"},{\"location\":{\"latitude\":37.3762487,\"longitude\":-122.0332551},\"company\":\"Thai Basil\",\"description\":\"101 S Murphy Ave, Sunnyvale, CA 94086\\n Free Thai iced tea with lunch!\",\"provider\":\"Yelp\"}]}");
            dealDatabase.add(record);
