...
public class DealFinder {
    ...
    private void populateDealDatabase() {
        ...
        try {
            ...
            //restaurants
            record = new JSONObject("{\"southwest\":{\"latitude\":37.390322,\"longitude\":-122.031695},\"northeast\":{\"latitude\":37.3960397,\"longitude\":-122.0332951},\"dealType\":\"restaurant\",\"deals\":[{\"location\":{\"latitude\":37.394321,\"longitude\":-122.0310037},\"company\":\"Dish n' Dash\",\"description\":\"Free salad/fries with lunch!\",\"provider\":\"Yelp\"},{\"location\":{\"latitude\":37.394321,\"longitude\":-122.0310037},\"company\":\"Hobee's\",\"description\":\"Free drink with lunch/dinner!\",\"provider\":\"Yelp\"}]}");
            dealDatabase.add(record);
            record = new JSONObject("{\"southwest\":{\"latitude\":37.3865918,\"longitude\":-122.0350413},\"northeast\":{\"latitude\":37.3889616,\"longitude\":-122.0301597},\"dealType\":\"restaurants\",\"deals\":[{\"location\":{\"latitude\":37.3865267,\"longitude\":-122.0331342},\"company\":\"Le Boulanger\",\"description\":\"15% off lunch! Valid today only\",\"provider\":\"Yelp\"},{\"location\":{\"latitude\":37.3865267,\"longitude\":-122.0331342},\"company\":\"Kal's Bar-B-Q\",\"description\":\"Free drink with lunch/dinner!\",\"provider\":\"Yelp\"}]}");
            dealDatabase.add(record);
            record = new JSONObject("{\"southwest\":{\"latitude\":37.3772527,\"longitude\":-122.0338413},\"northeast\":{\"latitude\":37.379361,\"longitude\":-122.026205},\"dealType\":\"restaurant\",\"deals\":[{\"location\":{\"latitude\":37.37,\"longitude\":-122.03},\"company\":\"Inchin's Bamboo Garden\",\"description\":\"Free drink with dinner!\",\"provider\":\"Yelp\"},{\"location\":{\"latitude\":37.3762487,\"longitude\":-122.0332551},\"company\":\"Thai Basil\",\"description\":\"Free Thai iced tea with lunch!\",\"provider\":\"Yelp\"}]}");
            dealDatabase.add(record);
