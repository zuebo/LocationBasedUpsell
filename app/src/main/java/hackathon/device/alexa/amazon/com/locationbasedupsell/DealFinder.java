...
public class DealFinder {
    ...
    private void populateDealDatabase() {
        ...
        try {
            ...
            //restaurants
            record = new JSONObject("{\"southwest\":{\"latitude\":37.390322,\"longitude\":-122.031695},\"northeast\":{\"latitude\":37.4000915,\"longitude\":-122.0281141},\"dealType\":\"restaurant\",\"deals\":[{\"location\":{\"latitude\":37.394321,\"longitude\":-122.0310037},\"company\":\"Dish n' Dash\",\"description\":\"Free salad/fries with lunch!\",\"provider\":\"Yelp\"},{\"location\":{\"latitude\":37.394321,\"longitude\":-122.0310037},\"company\":\"Hobee's\",\"description\":\"Free drink with lunch/dinner!\",\"provider\":\"Yelp\"}]}");
